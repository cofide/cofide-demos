...
build-demos: build-ping-pong build-ping-pong-mesh build-ping-pong-cofide build-aws-oidc build-gcp-oidc build-ping-pong-jwt build-ping-pong-exchange build-bank
